...
type UserServiceClient interface {
	...
	CreateUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*NewUserResponse, error)
}
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*NewUserResponse, error) {
...
type UserServiceServer interface {
	...
	CreateUser(context.Context, *NewUserRequest) (*NewUserResponse, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *NewUserRequest) (*NewUserResponse, error) {
